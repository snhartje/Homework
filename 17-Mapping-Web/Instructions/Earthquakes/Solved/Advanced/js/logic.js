...
var layers = {
  zero_one: new L.LayerGroup(),
  one_two: new L.LayerGroup(),
  two_three: new L.LayerGroup(),
  three_four: new L.LayerGroup(),
  four_five: new L.LayerGroup(),
...
piratesMap.addTo(map);

// Create an overlays object to add to the layer control
var overlays = {
  "0-1": layers.zero_one,
  "1-2": layers.one_two,
  "2-3": layers.two_three,
  "3-4": layers.three_four,
  "4-5": layers.four_five,
  "5+": layers.five_plus
};
